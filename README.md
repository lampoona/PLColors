# PLColors (Public Library Colors)
PLColors is an R Color palette package inspired by classic books found at the local public library.  


Palettes were extracted from vintage book covers using [Adobe Color](https://color.adobe.com/create/image). Using Adobe Color's accessibility tool, a majority of palettes are rendered to be <color-blind safe</b> for beautiful and inclusive data vizualisations. 
